          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative bg-cream border border-navy/10 rounded-2xl p-8 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col ${service.isLead ? 'md:col-span-2 lg:col-span-2 bg-navy text-white border-none' : ''}`}>
                ...
                <p
                  className={`text-lg mb-8 flex-grow ${service.isLead ? 'text-white/80 max-w-md' : 'text-black/70'}`}>
